...
{
    private ArrayList<Bot> rats = new ArrayList<Bot>(); 
...
//    }
    ...
    public void paintComponent(Graphics g)
    {
        ...
        for(int rb=0; rb<rats.size(); rb++)
        {
            ...
            int averagePointsPerRound = (int)(r.getTotalScore()/Math.max(RatBotWorld.getRoundNum()-1,1));
