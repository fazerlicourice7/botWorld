...
/**
 * A BotBrain is the 'brain' for a Rat in the game of RatBots. Each time that a
 * Rat is given its turn to act, it asks its BotBrain how it should act. The Rat
 * also provides the BotBrain with all of the sensor information it has.
 * </br>
 * It is important to note that even though a BotBrain has a Location, changing
 * that location does not actually move the Rat (or the BotBrain.) It is only
 * changing where you think you are, but really you're only fooling yourself.
 * The same is true about the other parameters a BotBrain has.
 * </br>
 * While this structure is intended to keep you from 'cheating' the game. I'm
 * sure some of you will find a way around it. Therefore, it is a rule that any
 * attempts to work around the rules will eliminate you from all competitions.
 * (Although I would like to get feedback so that I can improve how the game
 * works.)
 */
public class BotBrain {
    ...
    //Constructor=============================================================
    /**
     * Constructs a new RatBot. The name of the RatBot will be 'default' until
     * it is changed.
     */
    public BotBrain() {
        name = "default";
    ...
    /**
     * This method should include code that will initialize this BotBrain at the
    ...
    public void setPreferredColor(Color in) {
        preferredColor = in;
    }
    ...
    public void setMoveNumber(int in) {
        moveNumber = in;
    }

    public void setRoundNumber(int in) {
        roundNumber = in;
    }
    ...
    public void setBestScore(int in) {
        bestScore = in;
    }

    public void setRoundsWon(int in) {
        roundsWon = in;
    }

    // -------- USEFUL METHODS ---------------------------------------
    /**
     * This method should be used to determine if you can move in a given
     * direction.
     *
